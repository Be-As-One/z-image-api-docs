---
title: Get Task Status API - Check Generation Progress
description: 'Poll task status and retrieve AI generation results. Complete API reference for checking image and video generation progress with code examples in Node.js, Python, and cURL.'
...
<ParamField query="taskId" type="string" required>
  The task ID returned from the 👉 [Create Task](create-task) endpoint
</ParamField>
